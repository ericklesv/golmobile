...
export interface GoleadaBoard {
  mine: { team: Team; goals: number };
  rival: { team: Team; goals: number } | null;
}
...
export interface AdminFutPregoRow {
  ...
  repeated?: boolean; // revanche repetida: sem gol e fora das 10 partidas da hora
}
