...
export const GOLEADA = {
  ...
  keeper: {
    ...
    // O COMEÇO É UM PASSEIO (dono, 18/09/2026: "o goleiro tá muito rápido até no nível inicial… já começa
    // muito difícil"): no primeiro segundo ele fecha ~18% da boca do gol, contra 31% de antes. O FIM não
    // mudou — aos 100 s ele volta a fechar 78%, que é o aperto de sempre. É o relógio que endurece.
    periodFirst: 4800, // ms para ir e voltar no começo da série…
    periodLast: 1150, // …e quando o jogo já apertou
    reactFirst: 520, // ms até ele largar a ronda e mergulhar na bola…
    reactLast: 140, // …no fim
    speedFirst: 0.50, // larguras de gol por segundo no mergulho…
