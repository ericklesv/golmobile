...
function Scene({ shot, teamColor }: { shot: Shot | null; teamColor: string }) {
  ...
  return (
    <>
      ...
      <fog attach="fog" args={['#7fc5ff', 35, 80]} />
    </>
  );
}
  ...
  return (
    <div className="app-frame relative flex min-h-full flex-col">
      ...
      <div className="h-[62vh] w-full">
        <Canvas shadows camera={{ position: [3.5, 2.2, 25], fov: 50 }} dpr={[1, 1.75]} gl={{ antialias: true }} style={{ background: 'linear-gradient(#46b4ff, #1f7ae6)' }}>
