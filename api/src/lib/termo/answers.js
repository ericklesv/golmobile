 ...
 * Corujão no mesmo dia.
 *
 * **Daqui em diante, palavra nova entra no fim**, e antes de a lista acabar (a última
 * cai no dia #108, 28/12/2026; depois o calendário dá a volta). Tirar, trocar de lugar
...
export const ANSWERS = [
  "VIRAR", "TAÇAS", "SPORT", "JOGOS", "PERDE", "PENTA", "LIGAS", "BAHIA",
  "NOTAS", "FAIXA", "BATER", "APITO", "PONTA", "GINGA", "CHAPE", "PENAL",
  "SUADA", "LANÇA", "PUXÃO", "REDES", "CEARÁ", "GANHA", "VOLTA", "ÍDOLO",
  "VIBRA", "GRUPO", "RUBRO", "MANTO", "TOQUE", "MISTO", "TRAVA", "SÉRIE",
  "CONES", "COBRA", "GRAMA", "PONTE", "TIMBA", "SÓCIO", "CRUZA", "MATAR",
  "BOMBA", "BRAGA", "VENCE", "TIMES", "RIVAL", "CAMPO", "TURNO", "RACHA",
  "PAPÃO", "DUPLA", "MEIAS", "CLUBE", "HINOS", "QUICA", "ARENA", "ASTRO",
  "MENGO", "BOLAS", "TEMPO", "NOITE", "BANCO", "SALVA", "GARRA", "TORCE",
  "CAVAR", "PONTO", "INTER", "FINAL", "LANCE", "TROCA", "CHUTE", "TÚNEL",
  "CANTO", "DUELO", "PORCO", "VAIAS", "PEITO", "TRAVE", "RECUO", "BOLÃO",
  "JOGAR", "COPAS", "SOBRA", "GOIÁS", "SAÍDA", "MEIÃO", "SALDO", "ROUBO",
  "VASCO", "ZEBRA", "MARCA", "GRITO", "PISÃO", "SANTA", "FALTA", "JUÍZA",
  "LINHA", "DÉRBI", "PEIXE", "LÍDER", "TETRA", "PÓDIO", "FINTA", "ATACA",
  "LUVAS", "TIMÃO", "PASSE", "BAGRE",
];
