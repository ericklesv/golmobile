    ...
    <div className="flex flex-col gap-4">
      ...
      <Panel title="OS CHUTES" ribbon="orange">
        <ul className="flex flex-col gap-2 text-[13px] font-bold text-navy-ink">
          ...
          <li><b className="text-gold-deep">Party GoL</b> — a roleta: aposta {fmt(meta?.money.PARTY_BET ?? 500)}, acertou leva {fmt(meta?.money.PARTY_PRIZE ?? 1500)}. 5 giros por dia (VIP: 10); a primeira vitória do dia vale gol.</li>
          <li><b className="text-grass-deep">Saldo nos minigames</b> — cada vitória nos minigames diários (Termo, Quiz, Estatísticas, Memória, De que time é?, Camisas, Alvo no Gol, Hat Trick, Falta PRO, Ganha ou Perde) dá {fmt(meta?.money.MINIGAME_WIN ?? 500)} além do gol.</li>
