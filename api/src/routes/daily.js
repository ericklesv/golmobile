...
import { goleadaState, goleadaStart, goleadaEnd } from '../services/goleada.js';
...
// Goleada (batedor): GET estado, POST start (abre a série e manda a semente) e POST end (os chutes)
