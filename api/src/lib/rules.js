...
// Alvo no Gol: vira à meia-noite. 10 alvos acendem um a um (posição sorteada), cada um fica
// aceso 1,5 s (relógio no servidor). +3 de nível por acerto (até +30); 7 acertos = 1 gol.
