    ...
    <div className="flex flex-col gap-4">
      ...
      <Panel title="OS CHUTES" ribbon="orange">
        <ul className="flex flex-col gap-2 text-[13px] font-bold text-navy-ink">
          ...
          <li><b className="text-orange-deep">FutPrego</b> — futebol de prego 1x1 ao vivo, uma vez de cada: arraste para trás e solte para dar o peteleco, e a bola quica nos pregos. Quem desafia espera alguém aceitar (quem está nas telas do jogo recebe o convite). Cada um põe {fmt(meta?.futprego?.bet ?? 200)}; quem fizer o primeiro gol leva {fmt((meta?.futprego?.bet ?? 200) * 2)} e 1 gol para o time, e o time do outro perde 1 gol na rodada. Sem gol em {meta?.futprego?.maxTurns ?? 10} jogadas de cada, o dinheiro volta. Até {meta?.futprego?.maxGoalWinsPerDay ?? 3} gols por dia; ganhar da mesma pessoa duas vezes seguidas, a segunda não vale gol. Times e internets diferentes. Libera para todos.</li>
