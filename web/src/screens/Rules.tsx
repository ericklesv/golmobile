    ...
    <div className="flex flex-col gap-4">
      ...
      <Panel title="OS CHUTES" ribbon="orange">
        <ul className="flex flex-col gap-2 text-[13px] font-bold text-navy-ink">
          ...
          <li><b className="text-gold-deep">Party GoL</b> — a roleta: aposta {fmt(meta?.money.PARTY_BET ?? 100)}, acertou leva {fmt(meta?.money.PARTY_PRIZE ?? 300)}. 10 giros por dia; a primeira vitória do dia vale gol.</li>
